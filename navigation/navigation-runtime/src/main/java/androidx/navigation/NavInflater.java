...
public final class NavInflater {
    ...
    private static final String TAG_GESTURE_CONSTRAINT = "gesture-constraint";
    ...
    private void inflateAction(@NonNull Resources res, @NonNull NavDestination dest,
        ...
        action.setNavGesture(new NavGesture(a.getResourceId(R.styleable.NavAction_widgetOn,0)
                ,a.getInteger(R.styleable.NavAction_gesture,-1)));
