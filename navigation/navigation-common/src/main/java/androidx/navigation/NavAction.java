...
public final class NavAction {
    ...
    private NavGesture mNavGesture;
    ...
    /**
     * Gets the gesture needed to trigger the action.
     * @return an instance of NavGesture
     */
    public NavGesture getNavGesture () {
        return mNavGesture;
    }
    ...
    /**
     * Sets the gesture needed to trigger the action.
     *
     * @param navGesture gesture that will trigger the action
     */
    public void setNavGesture(NavGesture navGesture) {
        mNavGesture = navGesture;
    }
}
